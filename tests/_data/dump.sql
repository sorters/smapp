...
CREATE TABLE "stocks" ("id" integer not null primary key autoincrement, "product_id" integer not null, "provider_id" integer null, "quantity" float not null default '0', "unit_price" float null, "created_at" datetime null, "updated_at" datetime null, foreign key("product_id") references "products"("id"), foreign key("provider_id") references "providers"("id"));
